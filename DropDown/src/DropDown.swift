...
public final class DropDown: UIView {
    ...
    @objc public dynamic var tableBorderWidth: CGFloat = 0 {
        willSet {
    ...
    @objc public dynamic var tableBorderColor = UIColor.clear {
        willSet {
    ...
    @objc public dynamic var tableCornerRadius = DPDConstant.UI.CornerRadius {
        willSet {
            tableView.layer.cornerRadius = newValue
            tableViewContainer.layer.borderWidth = newValue
...
private extension DropDown {
    ...
    func setupUI() {
        ...
        tableViewContainer.layer.cornerRadius = tableCornerRadius
        ...
        tableViewContainer.layer.borderWidth = tableBorderWidth
        tableViewContainer.layer.borderColor = tableBorderColor.cgColor
